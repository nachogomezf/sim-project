...
- When developing our own algorithm we first decided the type of event and acted accordingly but that was not accurate since, before doing that, we should update the proportional part of the previous payments so that they would be taken into account in the next event
